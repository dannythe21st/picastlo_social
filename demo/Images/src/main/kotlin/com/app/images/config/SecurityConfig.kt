package com.app.images.config

import com.app.images.config.filters.JWTAuthenticationFilter
import com.app.images.config.filters.JWTUtils
import com.app.images.config.filters.UserPasswordAuthenticationFilterToJWT
    ...
    open fun securityFilterChain(
        ...
        http.invoke {
            ...
            authorizeHttpRequests {
                authorize("/images/public/**", permitAll)
