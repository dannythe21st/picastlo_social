package com.app.posts.config

import com.app.posts.config.filters.JWTAuthenticationFilter
import com.app.posts.config.filters.JWTUtils
import com.app.posts.config.filters.UserPasswordAuthenticationFilterToJWT
    ...
    open fun securityFilterChain(
        ...
        http.invoke {
            ...
            authorizeHttpRequests {
                authorize("/post/public**", permitAll)
